...
class eCampaignCategory(IntEnum):
    ...
    CHALLENGE_NUM_HARD = 75
    CHALLENGE_NUM_VERY_HARD = 76
...
class eBattleContentSupportPostType(IntEnum):
    EMPTY = 0
    ABYSS_QUEST = 1
    ABYSS_BOSS = 2
    MIRAGE_FLOOR = 3
    MIRAGE_NEMESIS = 4
    SEVEN_QUEST = 5
    SEVEN_BOSS_SCENARIO = 6
    SEVEN_BOSS_SP = 7
    SEVEN_BOSS_SP_PLUS = 8
    CROWN_QUEST = 9
    CROWN_BOSS_SCENARIO = 10
    LABYRINTH_QUEST = 11
    LABYRINTH_BOSS = 12
    MRE = 13
    TALENT_QUEST = 14
